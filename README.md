...
- Script Error / Missing Script: Halt the registry retrieval for this specific technology immediately. Do NOT act as a fallback and do NOT generate the rule yourself (to prevent unnecessary token consumption). Clearly report this failure to the user in your final output, then proceed to the next technology or the next step.
